...
class TestP739DailyTemperatures:
    def test_all(self): assert P739().run_quiet()
...
class TestP084LargestRectangle:
    def test_all(self): assert P084().run_quiet()
...
class TestP853CarFleet:
    def test_all(self): assert P853().run_quiet()
...
class TestP907SumOfSubarrayMinimums:
    def test_all(self): assert P907().run_quiet()
