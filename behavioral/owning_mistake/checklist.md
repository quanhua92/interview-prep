# Owning a Mistake — Story Workshop
...
- [ ] **Do you show transparency quickly — did you raise your hand and own it, not hide or minimize it?**
- [ ] **Is the corrective action specific and immediate? (What exactly did you do to fix it right then?)**
- [ ] **Do you describe what you put in place to prevent recurrence? (System/process change, not just "I'll be more careful next time")**
...
- [ ] **Verify it emphasizes a DIFFERENT type or severity of mistake** (e.g., if story 1 is a code bug that caused an outage, story 2 should be a process mistake, a communication error, or a smaller but recurring issue — pick a contrasting type/severity)
