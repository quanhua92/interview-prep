# Difficult Decision — Story Workshop
...
- [ ] **Is the trade-off clearly articulated? (What did you give up, and what did you gain?)**
- [ ] **Did you explain WHY you chose option A over option B, not just that you chose A?**
- [ ] **Can you quantify the impact of the decision (even approximately)?**
...
- [ ] **Verify it emphasizes a DIFFERENT type of decision** (e.g., if story 1 is a technical architecture choice, story 2 should be a people decision or a process/priority decision — pick a contrasting scenario)
