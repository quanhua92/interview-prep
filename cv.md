...
*GitHub: [github.com/quanhua92/aipriceaction](https://github.com/quanhua92/aipriceaction)*
  ...
  * Built a Python SDK ([aipriceaction](https://pypi.org/project/aipriceaction/)) and CLI ([aipa-cli](https://pypi.org/project/aipa-cli/)) with AI analysis across 13 templates.
...
### Skills
  ...
  * **ML/DL:** PyTorch, Computer Vision, 3D Reconstruction
  * **Frameworks:** LangChain, LangGraph, Qt, ESP-IDF, Axum, Tokio, React
  * **Infrastructure:** PostgreSQL, Redis, Docker, AWS (Lambda, S3, ECS), CI/CD
  * **AI Agents:** Multi-Agent Pipelines, Tool-Augmented LLMs, OpenAI API
