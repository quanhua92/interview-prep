# Meeting Deadline & Pressure — Story Workshop
...
- [ ] **Do you show composure under pressure (not panic or frantic behavior)?**
- [ ] **Did you prioritize, negotiate scope, or delegate — not just "I worked harder/longer"?**
- [ ] **Is the outcome realistic (e.g., met the deadline but with a known trade-off), not superhuman?**
...
- [ ] **Verify it emphasizes a DIFFERENT type of pressure** (e.g., if story 1 is an impossible single deadline, story 2 should be multiple competing deadlines or a production crisis — pick a contrasting scenario)
